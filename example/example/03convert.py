...
def run(src_file, dst_file, override_file):
    ...
    # fnname = b.get_functionname(src["FullUser"], dst["FullUser"])
    # func = b.build(fnname, src["FullUser"], dst["FullUser"])
    # fnname = b.get_functionname(src["User"], dst["FullUser"])
    # func = b.build(fnname, src["User"], dst["FullUser"])
    # fnname = b.get_functionname(src["FullUser"], dst["User"])
    # func = b.build(fnname, src["FullUser"], dst["User"])
    func = b.build_struct_convert(src["User"], dst["User"])
